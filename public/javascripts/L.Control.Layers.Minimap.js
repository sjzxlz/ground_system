...
require('http://g214.westgis.ac.cn/lib/leaflet/leaflet.sync');
...
L.Control.Layers.Minimap = L.Control.Layers.extend({
	options: {
		...
		topPadding: 10,
		bottomPadding: 40,
		overlayBackgroundLayer: L.tileLayer('../../../a{s}.acetate.geoiq.com/tiles/acetate-base/{z}/{x}/{y}.png', {
...
},{"leaflet-clonelayer":2,"http://g214.westgis.ac.cn/lib/leaflet/leaflet.sync":3}],2:[function(require,module,exports){
